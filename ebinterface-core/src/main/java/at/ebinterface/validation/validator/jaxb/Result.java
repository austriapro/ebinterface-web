...
/**
 * If the validationPassed attribute is false, validation failed. In this case Error Elements are
 * present and each Error Element specifies the particular violation. <p/> <p/> <p>Java class for
 * ResultType complex type. <p/> <p>The following schema fragment specifies the expected content
 * contained within this class. <p/>
 * <pre>
...
public class Result
  ...
  /**
   * Gets the value of the namespaces property. <p/> <p/> This accessor method returns a reference
   * to the live list, not a snapshot. Therefore any modification you make to the returned list will
   * be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the
   * namespaces property. <p/> <p/> For example, to add a new item, do as follows:
   * <pre>
   *    getNamespaces().add(newItem);
   * </pre>
   * <p/> <p/> <p/> Objects of the following type(s) are allowed in the list {@link Result.Namespace
   * }
   */
  ...
  /**
   * Gets the value of the errors property. <p/> <p/> This accessor method returns a reference to
   ...
   * errors property. <p/> <p/> For example, to add a new item, do as follows:
   * <pre>
   *    getErrors().add(newItem);
   * </pre>
   * <p/> <p/> <p/> Objects of the following type(s) are allowed in the list {@link Result.Error }
   */
