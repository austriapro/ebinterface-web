...
/**
 * <p>Java class for SignatureType complex type. <p/> <p>The following schema fragment specifies the
...
public class SignatureType {
  ...
  /**
   * Gets the value of the object property. <p/> <p/> This accessor method returns a reference to
   ...
   * object property. <p/> <p/> For example, to add a new item, do as follows:
   * <pre>
   *    getObject().add(newItem);
   * </pre>
   * <p/> <p/> <p/> Objects of the following type(s) are allowed in the list {@link ObjectType }
   */
