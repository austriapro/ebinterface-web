...
/**
 * <p>Java class for VerificationReportType complex type. <p/> <p>The following schema fragment
...
public class VerificationReportType {
  ...
  /**
   * Gets the value of the signatureInfo property. <p/> <p/> This accessor method returns a
   ...
   * for the signatureInfo property. <p/> <p/> For example, to add a new item, do as follows:
   * <pre>
