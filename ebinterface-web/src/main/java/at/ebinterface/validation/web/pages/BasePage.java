...
/**
 * Base page for all web pages<br>
 * Note: don't rename
 *
 * @author pl
 */
public abstract class BasePage extends WebPage
{
  ...
  public BasePage ()
  {
    add (new Image ("ebInterface-logo", new PackageResourceReference (ImagesLogoAccessor.class, "ebinterface-logo.png")));
    add (new Image ("wko-logo", new PackageResourceReference (ImagesLogoAccessor.class, "wko-logo.png")));
  }

  @Override
  public void internalRenderHead (final HtmlHeaderContainer container)
  {
    final PackageResourceReference cssFile_wko = new PackageResourceReference (CssReference.class, "wkostyle.css");
    final CssHeaderItem cssItem_wko = CssHeaderItem.forReference (cssFile_wko);

    final PackageResourceReference cssFile_page = new PackageResourceReference (CssReference.class, "style.css");
    ...
    final PackageResourceReference jsReference = new PackageResourceReference (JsReference.class, "fileLabelChecker.js");
