...
/**
 * Types of languages supported by the {@link CodeBox} component. <p/> In general it is not
 * necessary to specify a language, however you can force one by using one of these enumerated
 * types.
 *
...
public enum CodeBoxLanguage {
  ...
  COMMON_LISP("lang-cl", "lang-lisp.js"), EMACS_LISP("lang-el", "lang-lisp.js"), LISP(
      "lang-lisp", "lang-lisp.js"), SCHEME("lang-scm", "lang-lisp.js"), CSS("lang-css",
                                                                            "lang-css.js"), HASKELL(
      "lang-hs", "lang-hs.js"), LUA("lang-lua", "lang-lua.js"), PROTOCOL_BUFFERS(
      "lang-proto", "lang-proto.js"), SQL("lang-sql", "lang-sql.js"), VISUAL_BASIC("lang-vb",
                                                                                   "lang-vb.js"), VB_SCRIPT(
      "lang-vbs", "lang-vb.js"), GOOGLE_WIKI("lang-wiki",
