...
public class ResultPanelXRechnung extends Panel
{
  public ResultPanelXRechnung (String id,
                               final byte [] xml,
                               ...
                               @Nullable Class <? extends WebPage> returnPage)
  {
    ...
    Link <Void> xmllink = new Link <Void> ("linkXMLDownload")
    {
      ...
      public void onClick ()
      {
        ...
        ResourceStreamRequestHandler handler = new ResourceStreamRequestHandler (rstream, "XRechnung-Invoice.xml");
