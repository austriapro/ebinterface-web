...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (StartForm.class);
  ...
  protected void submit (final EBasicEbiActionType selectedAction)
  {
    ...
    switch (selectedAction)
    {
      case SCHEMA_VALIDATION:
        ...
        setResponsePage (new ResultPageEbInterface (validationResult, null, null, null, StartPage.class));
        break;
