...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (XRechnungToEbiForm.class);
  ...
  public XRechnungToEbiForm (final String id, @Nonnull final Class <? extends WebPage> aReturnPage)
  {
    super (id);
  ...
  protected void onSubmit ()
  {
    ...
    // Redirect
    setResponsePage (new ResultPageXRechnungToEbi (pdf, ebInterface, sbLog.toString (), m_aReturnPage));
  }
