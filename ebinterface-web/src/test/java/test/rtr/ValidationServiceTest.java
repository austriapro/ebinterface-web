...
public class ValidationServiceTest
{
  ...
  public void testValidationService () throws Exception
  {
    ...
    String invoice = StreamHelper.getAllBytesAsString (getClass ().getResourceAsStream ("/ebinterface/3p02/valid_and_signed.xml"),
    ...
    {
      LOG.error ("Fehler bei der Verarbeitung. Error code {}, Error message {}",
                 verificationFault.getFaultInfo ().getErrorCode (),
                 verificationFault.getFaultInfo ().getInfo ());
    }
    ...
    invoice = StreamHelper.getAllBytesAsString (this.getClass ().getResourceAsStream ("/ebinterface/3p02/mesonic1-corrupted.xml"),
                                                StandardCharsets.UTF_8);
